...
Passionate about AI, Data Science, and Full Stack Development. I enjoy building real-world applications and continuously learning new technologies.
...
- 🌱 Learning Spring Boot, React & Data Science
...
`Machine Learning` `Deep Learning` `Spring Boot` `React` `DSA`
